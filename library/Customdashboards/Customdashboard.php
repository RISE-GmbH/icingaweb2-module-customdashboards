 ...
 *
 */
class Customdashboard extends AbstractWidget
{
    /**
    ...
    public function load()
    {
        ...
        // do to load any dashboard associated with a module
        $panes = array();
    ...
    {
        $url = Url::fromPath('customdashboards/custom-dashboard')->getUrlWithout($this->tabParam);
        if ($this->tabs === null) {
            $this->tabs = new Tabs();
